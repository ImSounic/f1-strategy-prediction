...
def write_typescript(all_results: list, out_dir: str = "frontend/src/data"):
    ...
    # Legacy types used by ScenarioView (contingency scenario planner)
    lines.append("// Legacy types used by ScenarioView (contingency scenario planner)")
    lines.append("export interface DecisionTrigger {")
    lines.append("  icon: string;")
    lines.append("  trigger: string;")
    lines.append("  probability: number;")
    lines.append("  timeSaved: number;")
    lines.append("}")
    lines.append("")
    lines.append("export interface ScenarioStrategy {")
