    ...
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 pt-24">
        <div className="max-w-4xl">
          {/* Tag */}
          <div className="animate-fade-in-up stagger-1 inline-flex items-center gap-2 px-3 py-1 rounded-full border border-f1-border bg-f1-card/50 backdrop-blur-sm mb-8">
            ...
            <span className="text-xs font-mono text-f1-muted uppercase tracking-wider">
              University of Twente &middot; Data Science Module
            </span>
          </div>

          {/* Headline */}
          <h1 className="animate-fade-in-up stagger-2 font-display font-black text-5xl md:text-7xl lg:text-8xl leading-[0.9] tracking-tight mb-6 text-f1-light">
            F1 Race
            <br />
            Strategy
            <br />
          ...
          <div className="animate-fade-in-up stagger-4 flex flex-wrap gap-4">
            <button
              ...
              className="group px-8 py-3 bg-f1-red text-white font-display font-bold text-sm uppercase tracking-wider hover:bg-red-700 transition-all glow-red rounded"
            >
              How It Works
            ...
            <button
              ...
              className="px-8 py-3 border border-f1-border text-f1-light font-display font-bold text-sm uppercase tracking-wider hover:border-f1-red hover:text-f1-red transition-all rounded"
            >
              Explore Circuits
            </button>
          </div>
        ...
        <div className="animate-fade-in-up stagger-5 mt-16 grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={i} className="theme-card rounded-xl p-4 hover:border-f1-red/30 transition-colors">
              <div className="font-display font-black text-3xl md:text-4xl text-f1-light">
                {loaded ? (
              ...
              <div className="font-mono text-xs text-f1-muted/60">{m.detail}</div>
            </div>
          ))}
        </div>
        ...
        <div className="animate-fade-in-up stagger-5 mt-10 hidden lg:block">
          <div className="flex items-center gap-1">
            {[
              { label: 'Data Ingestion', detail: '4 APIs &middot; 92 races', color: '#0090D0' },
              ...
              <div key={i} className="flex items-center">
                <div
                  className="rounded-lg px-4 py-3 border transition-all hover:scale-105 cursor-default shadow-card"
                  style={{
                ...
                >
                  ...
                  <div className="font-display font-bold text-sm text-f1-light mt-1">{step.detail}</div>
                </div>
                {i < 4 && (
                  <div className="text-f1-muted mx-2 font-mono text-lg">&rarr;</div>
                )}
              </div>
            ))}
          </div>
